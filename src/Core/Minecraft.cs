...
using System;
using MCBE.CLI.Launcher.System;
...
namespace MCBE.CLI.Launcher.Core;

abstract partial class Minecraft
{
...
partial class Minecraft
{
    ...
    protected static readonly IPackageDebugSettings s_packageDebugSettings = (IPackageDebugSettings)new PackageDebugSettings();
...
unsafe partial class Minecraft
{
    internal static bool IsInstalled => s_packageManager.FindPackagesForUser(string.Empty, PackageFamilyName).Any();

    internal static bool IsUnpackaged => s_packageManager.FindPackagesForUser(string.Empty, PackageFamilyName).First().IsDevelopmentMode;

    internal static bool HasUWPAppLifecycle
    {
        set
        {
...
unsafe partial class Minecraft
{
    internal static bool UsingGameDevelopmentKit
    {
        get
        {
            var package = s_packageManager.FindPackagesForUser(string.Empty, PackageFamilyName).First();
...
partial class Minecraft
{
    ...
    internal bool IsRunning => Window is { };
